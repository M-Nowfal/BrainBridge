        ...
        <form className="flex flex-col items-center space-y-7 justify-center min-h-svh">
          ...
          <Card className="w-[95%] max-w-lg">
            ...
            <CardContent className="flex flex-col gap-7">
              ...
              <Link to={"/register"} className="text-center text-sky-600 font-semibold hover:underline hover:underline-offset-3">
                Don't have an account? Sign up
              </Link>
              <Link to={"/resetpwd"} className="text-center text-muted-foreground font-semibold hover:underline hover:underline-offset-3">
