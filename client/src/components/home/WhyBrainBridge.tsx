...
const WhyBrainBridge = () => {
  ...
  return (
    <section className="mt-20">
      ...
      <p className="text-lg text-center text-muted-foreground font-semibold mt-5">Experience learning like never before with our innovative platform designed for modern education.</p>
      <div className="grid sm:grid-cols-2 lg:grid-cols-3 w-[95%] max-w-7xl m-auto gap-5 mt-12">
        {choose_brain_bridge.map(choose => (
