  ...
  return (
    <section className="text-center mt-20">
      ...
      <MotionUp>
        ...
        <p className="text-xl m-auto text-muted-foreground w-5/6">
          Start your journey with our most loved courses by expert instructors.
        </p>
      </MotionUp>
      ...
      <div className="grid sm:grid-cols-2 lg:grid-cols-3 m-auto w-[95%] max-w-7xl gap-5 mt-10">
        {popular_courses.map((course, idx) => (
          <MotionUp key={idx}>
            <Card className="group relative hover:-translate-y-2 overflow-hidden shadow-md hover:shadow-lg transition-all duration-200 p-0 pb-5">
              {/* Course thumbnail */}
              <img
              ...
              <CardContent className="absolute top-3 w-full">
                <div className="flex justify-between text-xs">
                  <span className="bg-white/70 dark:bg-black/70 rounded-md py-1 px-2 dark:text-white font-semibold">
                    {course.category}
                  </span>
                  <span className="bg-white/70 dark:bg-black/70 rounded-md py-1 px-2 dark:text-white font-semibold">
                    {course.level}
              ...
              {/* Instructor, rating, pricing, and CTA */}
      ...
      <MotionUp className="flex justify-center mt-10">
        <Button
          size="lg"
          variant="outline"
          className="group text-lg w-full max-w-xs p-6 hover:scale-105"
